...
public class SignupOne extends JFrame implements ActionListener{
    ...
    JTextField nameTextField,fnameTextField,dobTextField,emailTextField,addressTextField,cityTextField,countryTextField,pinTextField;
    ...
    SignupOne()
    {
        ...
        //jdatechooser class for adding calender  
        ...
        //JRadioButton class for adding Radio button
    ...
    public void actionPerformed(ActionEvent ae){
        String formno=""+ random; //long converted to string by ""+
        ...
        try{
            ...
            if(name.equals("")){
                ...
                String query = "insert into signup values('"+formno+"', '"+name+"', '"+fname+"', '"+dob+"', '"+gender+"', '"+email+"', '"+marital+"', '"+address+"', '"+city+"', '"+country+"', '"+pin+"')";
